    ...
    return (
        <div>
            ...
            <form>
                ...
                <div className="form-group">
                    <label htmlFor="exampleFormControlTextarea1">Project title</label>
                    <textarea className="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                </div>
                <div className="form-group">
                    <label htmlFor="exampleFormControlTextarea1">Project intro</label>
                    <textarea className="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                    <label htmlFor="exampleFormControlInput1">Dateline</label>
